...
public class UIHandler : MonoBehaviour
{
    ...
    {
        ammoText.text = weapon.GetCurrentMag() + " / " + rm.Get(ResourceManager.ItemType.Ammo).ToString();
    }
    ...
    {
        batteryText.text ="batteries "+ rm.Get(ResourceManager.ItemType.Batteries) + " / 5";
    }
