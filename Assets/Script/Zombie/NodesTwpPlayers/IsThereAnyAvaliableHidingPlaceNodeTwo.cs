...
public class IsThereAnyAvaliableHidingPlaceNodetWO : Node
{
    ...
    public IsThereAnyAvaliableHidingPlaceNodetWO(Cover[] avaliableCovers, Transform target, Transform targetTwo, EnemyAI ai)
    {
